...
| enableRotateTo | Boolean – defines if the camera should automatically rotate to the vector defined with the rotateTo prop | false |
| rotateTo | Vector3 – position to rotate automatically to, for example {x:0,y:0,z:0} | undefined |
